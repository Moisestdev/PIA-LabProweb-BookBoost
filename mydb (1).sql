...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2025 a las 23:10:37
...
INSERT INTO `libro` (`id_libro`, `nombre_libro`, `id_autor`, `id_genero`, `id_usuario`, `portada_url`) VALUES
(1, 'Prueba', 1, 1, 5, 'https://r-charts.com/es/miscelanea/procesamiento-imagenes-magick_files/figure-html/color-fondo-imagen-r.png');
